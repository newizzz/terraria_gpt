...
### Лучник:
```py
- Броня: Броня: Легкая кольчуга (Warding, если это возможно)
- Оружие: Молниеносный лук (Stormbow)
- Аксессуары:
--- Перчатки лучника (Ranger Gloves)
--- Щит Скифа (Shield of Cthulhu)
--- Небесные сапоги (Hermes Boots)
```

### Стрелок
```py
Броня: Кожаный доспех (Warding, если это возможно)
Оружие: Кольт (Handgun)
Аксессуары:
--- Патроны в ящике (Ammo Box)
--- Оковы с наконечниками (Spiky Anklet)
--- Щит Скифа (Shield of Cthulhu)
```
### Призыватель:
```py
...
- Аксессуары:
--- Рассеивающая шкатулка (Mana Regeneration Band)
--- Значок путешественника (Traveler's Emblem)
--- Механический шар (Mechanical Cart)
```
...
- Аксессуары:
--- Золотой щит (Gold Shield)
--- Глазный шар (Eye of the Cthulhu)
--- Перчатки воина (Warrior's Gloves)
```
